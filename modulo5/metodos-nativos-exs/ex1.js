...
let resultado = string.slice(0, 10).toUpperCase();

console.log(resultado);

// Exercício 2 - Dada a string 'Aprendendo Javascript', extraia a palavra 'Aprendendo' e, em seguida, converta essa palavra em letras minúsculas.
...
let fraseNova = frase.replace('Python', 'Javascript');
let fraseNova2 = frase.replace(palavraExtrair, 'Javascript');

// console.log(palavraExtrair);

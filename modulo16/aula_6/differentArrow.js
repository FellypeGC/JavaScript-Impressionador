...
// myNormalLoggingFunction('Teste da minha função normal armazenada numa variável');
...
// myLoggingFunctionWithOnlyOneParameter('chamada de função da minha arrow function sem parênteses');

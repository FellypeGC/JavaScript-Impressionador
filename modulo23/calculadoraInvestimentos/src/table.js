...
export const createTable = (columnsArray, dataArray, tableId) => {
  if (
    ...
    throw new Error(
      'Para a correta execução, precisamos de um array com as colunas, outro com as informação das linhas e também o id do elemento tabela selecionado.'
    );
  }
...
function createTableHeader(tableReference, columnsArray) {
  ...
  */
  ...
  const tableHeaderReference = tableReference.querySelector('thead') ?? createTheadElement(tableReference); //<table><thead></thead></table>
  ...
  //<tr><th class='text-center'></th></tr><tr><th class='text-center'></th></tr>
